...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cvMasonryGallery = __webpack_require__(159);

	var _cvMasonryGallery2 = _interopRequireDefault(_cvMasonryGallery);

	exports['default'] = { MasonryGallery: _cvMasonryGallery2['default'] };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _masonryImage = __webpack_require__(160);

	var _masonryImage2 = _interopRequireDefault(_masonryImage);

	var load = function load(url) {
	  return new Promise(function (resolve) {
	    var img = new Image();
	    img.onload = function () {
	      resolve({ url: url, ratio: img.naturalWidth / img.naturalHeight });
	    };
	    img.src = url;
	  });
	};

	var descentOrder = function descentOrder(a, b) {
	  var ratioA = a.ratio;
	  var ratioB = b.ratio;
	...
	var MasonryGallery = (function (_React$Component) {
	  function MasonryGallery(props) {
	    var _this = this;

	    _classCallCheck(this, MasonryGallery);

	    _get(Object.getPrototypeOf(MasonryGallery.prototype), 'constructor', this).call(this, props);
	    this.state = { images: [] };
	    Promise.all(this.props.images.map(load)).then(function (ratios) {
	      return ratios.sort(descentOrder);
	    }).then(function (orderRatios) {
	      return _this.setState({ images: orderRatios });
	    });
	  }
	  ...
	  _createClass(MasonryGallery, [{
	    ...
	    value: function render() {
	      var widest = this.state.images.length ? this.state.images[0].ratio : null;
	      return _react2['default'].createElement(
	        'div',
	        { className: 'cv-MasonryGallery' },
	        this.state.images.map(function (image, index) {
	          return _react2['default'].createElement(_masonryImage2['default'], { key: index, src: image.url, ratio: image.ratio, widest: widest });
	        })
	      );
	    }
	  }]);
	...
	MasonryGallery.propTypes = { images: _react2['default'].PropTypes.array.isRequired };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SMALLEST_WIDTH = 300; /*px*/

	var MasonryImage = (function (_React$Component) {
	  function MasonryImage() {
	    _classCallCheck(this, MasonryImage);

	    _get(Object.getPrototypeOf(MasonryImage.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(MasonryImage, _React$Component);

	  _createClass(MasonryImage, [{
	    key: 'render',
	    value: function render() {
	      var flex = 1 / (this.props.widest / this.props.ratio);
	      flex = flex !== 0 ? flex : 1;
	      var width = SMALLEST_WIDTH * flex;

	      return _react2['default'].createElement(
	        'figure',
	        { className: 'cv-MasonryGallery-figure', style: { flex: flex, minWidth: width } },
	        _react2['default'].createElement('img', { className: 'cv-MasonryGallery-image', src: this.props.src })
	      );
	    }
	  }]);
